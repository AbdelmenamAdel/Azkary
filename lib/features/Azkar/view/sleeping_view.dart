...
class SleepingAzkarView extends StatelessWidget {
  const SleepingAzkarView({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: customAppbar(context, title: "أذكار النوم"),
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ZekrCardWidget(
                    model: cubit.sleeping[index],
                    zekrName: 'sleeping',
                    sort: index + 1,
                  );
                },
                itemCount: Azkar().sleeping.length,
              );
            },
          ),
        ),
